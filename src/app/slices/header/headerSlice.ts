...
import { HeaderType, TypesOfHeader } from '@/app/types/TypesOfData/header/header-type';
...
export const { setTypeOfHeader, setInputSearchBar, setHeaderClickBack, setHeader, setTitleOfHeader, setExecuteButton } =
  HeaderSlice.actions;
